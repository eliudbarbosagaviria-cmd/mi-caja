    ...
    <div style={{background:bgColor,border:`1px solid ${borderColor}`,borderRadius:10,padding:"12px 14px",marginBottom:14}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:10}}>
        <div style={{textAlign:"center",background:"#f0ece0",borderRadius:8,padding:"8px 4px"}}>
          <div style={{fontSize:9,color:"#8a8268",textTransform:"uppercase",letterSpacing:1,marginBottom:4}}>Inicial</div>
        ...
        <div style={{textAlign:"center",background:"#f0ece0",borderRadius:8,padding:"8px 4px"}}>
          ...
          <div style={{fontSize:8,color:"#8a8268",marginTop:2}}>= Ini + Vtas − Gas</div>
        </div>
        <div style={{textAlign:"center",background:"#f0ece0",borderRadius:8,padding:"8px 4px"}}>
    ...
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.8)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:300}}>
      <div style={{background:"#ece0bd",border:"1px solid #c4bda3",borderRadius:16,padding:24,width:380,maxWidth:"92vw",maxHeight:"90vh",overflowY:"auto"}}>
        ...
        <div style={{background:"#e8e4d8",border:"1px solid #d4cfba",borderRadius:10,padding:14,marginBottom:14}}>
          ...
          {[["Caja Inicial",data.saldoInicial,"#7a7258",""],["+ Ventas efectivo",c.ventas,"#236b46","+"],["+ Depósitos",c.depositos,"#1f7a8a","+"],["− Gastos",c.gastos,"#a3392a","−"],["− Retiros",c.retiros,"#a3621f","−"]].map(([label,val,color,sign])=>(
            ...
            return(
              <div key={local.id} style={{background:"#f3efe2",border:`1px solid ${local.color}44`,borderRadius:12,overflow:"hidden"}}>
                ...
                <div style={{padding:12}}>
                  ...
                  {[["Caja Inicial",d.saldoInicial,"#7a7258"],["Ventas",c.ventas,"#236b46"],["Depósitos",c.depositos,"#1f7a8a"],["Gastos",c.gastos,"#a3392a"],["Retiros",c.retiros,"#a3621f"]].map(([l,v,col])=>(
...
function CajaLocal({local, user}) {
  ...
  return(
    <div style={{background:"#f3efe2",border:`1px solid ${hayDescuadre?"#d99a8f":accent+"44"}`,borderRadius:16,overflow:"hidden",position:"relative"}}>
      {flash&&<div style={{position:"absolute",top:12,left:"50%",transform:"translateX(-50%)",background:"#d5e8db",color:"#236b46",padding:"8px 22px",borderRadius:40,fontSize:12,zIndex:99,boxShadow:"0 4px 16px rgba(0,0,0,0.5)",whiteSpace:"nowrap"}}>{flash}</div>}
      ...
      <div style={{padding:10}}>
        ...
        <div>
          ...
          {dayData.movimientos.slice().reverse().map(mov=>{
            ...
            return(
              <div key={mov.id} style={{background:"#ece8da",border:"1px solid #ece7d8",borderRadius:8,padding:"9px 11px",marginBottom:5,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
...
function CajaFuerte() {
  ...
  return (
    <div style={{ position: "relative" }}>
      {flash && <div style={{ position: "fixed", top: 20, left: "50%", transform: "translateX(-50%)", background: "#d5e8db", color: "#236b46", padding: "8px 22px", borderRadius: 40, fontSize: 12, zIndex: 999, boxShadow: "0 4px 16px rgba(0,0,0,0.5)", whiteSpace: "nowrap" }}>{flash}</div>}
    ...
    <div style={{maxWidth:1400,margin:"0 auto",padding:isMobile?"18px 12px":"20px 32px"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr 1fr":"1fr 1fr 1fr",gap:12,marginBottom:20,alignItems:"stretch"}}>
        {datosHoy.map(({local,nombre,c,cy})=>{
          ...
          return(
            <div key={local.id} style={{background:"#ece7d8",border:`1px solid ${local.color}33`,borderRadius:14,padding:16}}>
        ...
        <div style={{background:"#ece0bd",border:"1px solid #c4bda3",borderRadius:14,padding:"14px 18px",gridColumn:isMobile?"1 / -1":"auto",display:"flex",flexDirection:"column",justifyContent:"space-between"}}>
          <div>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"2fr 1fr",gap:16}}>
        ...
        {/* Gráfica semana */}
        <div style={{background:"#f3efe2",border:"1px solid #d4cfba",borderRadius:14,padding:16,marginBottom:isMobile?20:0}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr 1fr 1fr":"1fr",gap:isMobile?12:14}}>
            {[[nombre1,ingL1,"#8a6f24"],[nombre2,ingL2,"#3a6fa0"],["Total",ingL1+ingL2,"#2c2a22"]].map(([nombre,val,color])=>(
              <div key={nombre} style={{textAlign:isMobile?"center":"left",display:isMobile?"block":"flex",justifyContent:isMobile?"normal":"space-between",alignItems:isMobile?"normal":"center"}}>
                <div style={{fontSize:9,color:"#8a8268",marginBottom:isMobile?4:0}}>{nombre}</div>
...
export default function App() {
  ...
  return(
    <div style={{fontFamily:"'Georgia', serif",minHeight:"100vh",background:"#e8e4d8",color:"#2c2a22",padding:"0 0 60px"}}>
      ...
      <div style={{display:"flex",borderBottom:"1px solid #d4cfba",background:"#ece7d8"}}>
